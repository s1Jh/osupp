...
double Perlin2D(double x, double y, unsigned int octaves, double persistence, int seed, double amplitude = 1.0);
...
template<typename T1, typename T2, typename T3> requires
    std::floating_point<T1> and
    std::floating_point<T2> and
...
bool Intersects(rect<RT> rect, vec2d<PT> p) {
    return (
            InRange(p.x, rect.position.x, rect.position.x + rect.size.w) &&
...
bool Intersects(rect<R1> left, rect <R2> right) {
    return (
            (
                    InRange(left.position.x, right.position.x, right.position.x + right.size.w) ||
                    InRange(left.position.x + left.size.w, right.position.x, right.position.x + right.size.w)
            ) &&
            (
                    InRange(left.position.y, right.position.y, right.position.y + right.size.h) ||
                    InRange(left.position.y + left.size.h, right.position.y, right.position.y + right.size.h)
            )
    );
}
...
double GetSide(line<LineT> P, vec2d<PointT> A) {
    return (P.B.x - P.A.x) * (A.y - P.A.y) -
           (P.B.y - P.A.y) * (A.x - P.A.x);
}
...
template<typename T1, typename T2>
std::optional<vec2d<T1>>
GetIntersect(line<T1> L1,
             line<T2> L2
) {
...
template<typename T>
Mat4<T> CreateProjection(float fov, float aspect_ratio, float nearz, float farz) {
...
template<typename T1, typename T2>
Mat4<T1> LookAt(const vec3d<T2> &eye, const vec3d<T2> &target, const vec3d<T2> &up) {
...
Mat4<T> Inverse(const Mat4<T> &mat) {
    ...
    inv[0][0] = (mat[1][2] * mat[2][3] * mat[3][1] - mat[1][3] * mat[2][2] * mat[3][1] +
                 mat[1][3] * mat[2][1] * mat[3][2] - mat[1][1] * mat[2][3] * mat[3][2] -
                 mat[1][2] * mat[2][1] * mat[3][3] + mat[1][1] * mat[2][2] * mat[3][3]) * invdet;
    inv[0][1] = (mat[0][3] * mat[2][2] * mat[3][1] - mat[0][2] * mat[2][3] * mat[3][1] -
                 mat[0][3] * mat[2][1] * mat[3][2] + mat[0][1] * mat[2][3] * mat[3][2] +
                 mat[0][2] * mat[2][1] * mat[3][3] - mat[0][1] * mat[2][2] * mat[3][3]) * invdet;
    inv[0][2] = (mat[0][2] * mat[1][3] * mat[3][1] - mat[0][3] * mat[1][2] * mat[3][1] +
                 mat[0][3] * mat[1][1] * mat[3][2] - mat[0][1] * mat[1][3] * mat[3][2] -
                 mat[0][2] * mat[1][1] * mat[3][3] + mat[0][1] * mat[1][2] * mat[3][3]) * invdet;
    inv[0][3] = (mat[0][3] * mat[1][2] * mat[2][1] - mat[0][2] * mat[1][3] * mat[2][1] -
                 mat[0][3] * mat[1][1] * mat[2][2] + mat[0][1] * mat[1][3] * mat[2][2] +
                 mat[0][2] * mat[1][1] * mat[2][3] - mat[0][1] * mat[1][2] * mat[2][3]) * invdet;
    inv[1][0] = (mat[1][3] * mat[2][2] * mat[3][0] - mat[1][2] * mat[2][3] * mat[3][0] -
                 mat[1][3] * mat[2][0] * mat[3][2] + mat[1][0] * mat[2][3] * mat[3][2] +
                 mat[1][2] * mat[2][0] * mat[3][3] - mat[1][0] * mat[2][2] * mat[3][3]) * invdet;
    inv[1][1] = (mat[0][2] * mat[2][3] * mat[3][0] - mat[0][3] * mat[2][2] * mat[3][0] +
                 mat[0][3] * mat[2][0] * mat[3][2] - mat[0][0] * mat[2][3] * mat[3][2] -
                 mat[0][2] * mat[2][0] * mat[3][3] + mat[0][0] * mat[2][2] * mat[3][3]) * invdet;
    inv[1][2] = (mat[0][3] * mat[1][2] * mat[3][0] - mat[0][2] * mat[1][3] * mat[3][0] -
                 mat[0][3] * mat[1][0] * mat[3][2] + mat[0][0] * mat[1][3] * mat[3][2] +
                 mat[0][2] * mat[1][0] * mat[3][3] - mat[0][0] * mat[1][2] * mat[3][3]) * invdet;
    inv[1][3] = (mat[0][2] * mat[1][3] * mat[2][0] - mat[0][3] * mat[1][2] * mat[2][0] +
                 mat[0][3] * mat[1][0] * mat[2][2] - mat[0][0] * mat[1][3] * mat[2][2] -
                 mat[0][2] * mat[1][0] * mat[2][3] + mat[0][0] * mat[1][2] * mat[2][3]) * invdet;
    inv[2][0] = (mat[1][1] * mat[2][3] * mat[3][0] - mat[1][3] * mat[2][1] * mat[3][0] +
                 mat[1][3] * mat[2][0] * mat[3][1] - mat[1][0] * mat[2][3] * mat[3][1] -
                 mat[1][1] * mat[2][0] * mat[3][3] + mat[1][0] * mat[2][1] * mat[3][3]) * invdet;
    inv[2][1] = (mat[0][3] * mat[2][1] * mat[3][0] - mat[0][1] * mat[2][3] * mat[3][0] -
                 mat[0][3] * mat[2][0] * mat[3][1] + mat[0][0] * mat[2][3] * mat[3][1] +
                 mat[0][1] * mat[2][0] * mat[3][3] - mat[0][0] * mat[2][1] * mat[3][3]) * invdet;
    inv[2][2] = (mat[0][1] * mat[1][3] * mat[3][0] - mat[0][3] * mat[1][1] * mat[3][0] +
                 mat[0][3] * mat[1][0] * mat[3][1] - mat[0][0] * mat[1][3] * mat[3][1] -
                 mat[0][1] * mat[1][0] * mat[3][3] + mat[0][0] * mat[1][1] * mat[3][3]) * invdet;
    inv[2][3] = (mat[0][3] * mat[1][1] * mat[2][0] - mat[0][1] * mat[1][3] * mat[2][0] -
                 mat[0][3] * mat[1][0] * mat[2][1] + mat[0][0] * mat[1][3] * mat[2][1] +
                 mat[0][1] * mat[1][0] * mat[2][3] - mat[0][0] * mat[1][1] * mat[2][3]) * invdet;
    inv[3][0] = (mat[1][2] * mat[2][1] * mat[3][0] - mat[1][1] * mat[2][2] * mat[3][0] -
                 mat[1][2] * mat[2][0] * mat[3][1] + mat[1][0] * mat[2][2] * mat[3][1] +
                 mat[1][1] * mat[2][0] * mat[3][2] - mat[1][0] * mat[2][1] * mat[3][2]) * invdet;
    inv[3][1] = (mat[0][1] * mat[2][2] * mat[3][0] - mat[0][2] * mat[2][1] * mat[3][0] +
                 mat[0][2] * mat[2][0] * mat[3][1] - mat[0][0] * mat[2][2] * mat[3][1] -
                 mat[0][1] * mat[2][0] * mat[3][2] + mat[0][0] * mat[2][1] * mat[3][2]) * invdet;
    inv[3][2] = (mat[0][2] * mat[1][1] * mat[3][0] - mat[0][1] * mat[1][2] * mat[3][0] -
                 mat[0][2] * mat[1][0] * mat[3][1] + mat[0][0] * mat[1][2] * mat[3][1] +
                 mat[0][1] * mat[1][0] * mat[3][2] - mat[0][0] * mat[1][1] * mat[3][2]) * invdet;
    inv[3][3] = (mat[0][1] * mat[1][2] * mat[2][0] - mat[0][2] * mat[1][1] * mat[2][0] +
                 mat[0][2] * mat[1][0] * mat[2][1] - mat[0][0] * mat[1][2] * mat[2][1] -
                 mat[0][1] * mat[1][0] * mat[2][2] + mat[0][0] * mat[1][1] * mat[2][2]) * invdet;
...
inline Mat3<T> MakeShearMatrix(const vec2d<T> &shear) {
    return Mat3<T>(
            {
                    1.f, std::tan(shear.x), 0.f,
                    std::tan(shear.y), 1.f, 0.f,
                    0.f, 0.f, 1.f
            }
    );
}
...
inline vec4d<T> NormalizeComponents(const vec4d<T> &v) {
    return vec4d<T>{Normalize(v.x), Normalize(v.y), Normalize(v.z), Normalize(v.w)};
}
...
inline vec3d<T1> Cross(const vec3d<T1> &A, const vec3d<T2> &B) {
    return vec3d<T1>
            {
                    A.y * (T1) B.z - A.z * (T1) B.y,
                    A.z * (T1) B.x - A.x * (T1) B.z,
